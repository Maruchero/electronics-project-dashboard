PROBLEMS:
- performance: it seems like the plotting can't keep up with all the data coming from the serial
- rotation deadzone: need to implement a deadzone for rotation to avoid jitter
- need for a way to count how many loops are skipped due to lacking of data
